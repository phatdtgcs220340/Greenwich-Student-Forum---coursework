<?php 
    ...
    class Message {
        ...
        public function toModal($currentPath = "./") {
            return '
            <button data-modal-target="message'.$this->messageId.'-modal" data-modal-toggle="message'.$this->messageId.'-modal" class="w-full mb-1 font-medium text-gray-900 bg-blue-300 hover:bg-blue-400 px-5 py-2.5 text-start" type="button">
              '.$this->title.'<span class="text-end font-normal"> '.$this->timeDifference().' ago</span>
            </button>
                ...
                <div class="relative p-4 w-full max-w-2xl max-h-full">
                    <div class="relative bg-white rounded-lg shadow">
                        ...
                        <div class="flex items-center p-4 md:p-5 border-t border-gray-200 rounded-b">
                            <form action="'.$currentPath.'delete-message.php" method="post">
                                <input class="hidden" name="message_id" value="'.$this->messageId.'">
                                <button data-modal-hide="message'.$this->messageId.'-modal" type="submit" class="py-2.5 px-5 ms-3 text-sm font-medium text-red-600 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-red-600 hover:text-white">Delete</button>
                            </form>
                        </div>
                    </div>
                </div>
